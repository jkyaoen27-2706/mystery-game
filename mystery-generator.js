class MysteryGenerator {
    constructor() {
        ...
        // Local CORS proxy (most reliable) - run: node local-cors-proxy.js
...
Return ONLY valid JSON, no markdown formatting. Ensure the JSON is complete and properly closed with all closing braces.`;
        ...
        try {
            ...
            // Local proxy uses path format with encoded URL
    ...
    // ... (rest of the methods: getDifficultyInstructions, getRandomItem)
    getDifficultyInstructions(difficulty) {
        // ... (your existing getDifficultyInstructions code)
        const instructions = {
            '1-4': {
