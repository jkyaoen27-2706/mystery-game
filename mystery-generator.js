class MysteryGenerator {
    constructor() {
        // This placeholder will be replaced by the secure GitHub Action's 'sed' command.
        this.apiKey = 'JEKYLL_PLACEHOLDER_API_KEY'; 
        
        // Revert to a stable proxy URL since the direct call is blocked by CORS.
        this.apiUrl = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent';
        this.useDirectCall = false; // <-- Force use of proxy now
        this.corsProxy = 'https://thingproxy.freeboard.io/fetch/'; // <-- New, more robust proxy
...
Return ONLY valid JSON, no markdown formatting. Ensure the JSON is complete and properly closed with all closing braces.`;
        ...
        try {
            // Use CORS proxy since direct calls are blocked
